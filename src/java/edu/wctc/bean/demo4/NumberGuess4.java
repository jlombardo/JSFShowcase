...
@ManagedBean
@SessionScoped
public class NumberGuess4 implements Serializable {
    ...
    public String processGuess() {
        ...
        FacesContext.getCurrentInstance().addMessage("numGuess", facesMsg);

        return null; // navigate back to original view page
    }
